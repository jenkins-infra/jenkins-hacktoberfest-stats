...
######
# This script retrieves information from GitHub to track Hacktoberfest participation in the Jenkins project.
...
getOrganizationData() {
  ...
  while true; do
    ...
    ((page++))
    # Dirty trick to avoid hitting secondary rate limit.
    sleep 15
  done
